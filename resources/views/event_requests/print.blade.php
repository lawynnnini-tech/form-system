...
<head>
    ...
    <style>
        ...
        .section-title { color: #4B0082; padding: 10px 0; font-weight: bold; margin-top: 20px; text-transform: uppercase; border-bottom: 2px solid #9370DB; }
        table { width: 100%; border-collapse: collapse; border: 1px solid #dbd8d8; margin-top: 10px; }
        td { padding: 10px; border: 1px solid #c0c0c0; }
        .label { width: 350px; padding: 10px; background-color: #f8f1fc; color: #4B0082; font-weight: bold; border: 1px solid #dbd8d8; vertical-align: top; }
        .row-highlight { background-color: #f5f5c4; }
        .value-text { font-size: 15px; color: #333; border-bottom: 1px solid #000; display: inline-block; width: 100%; padding-bottom: 3px; }
        .check-group { display: flex; flex-wrap: wrap; gap: 12px; }
        .check-item { display: flex; align-items: center; gap: 5px; }
        .purpose-table { width:100%; border-collapse: collapse; border: 3px solid #b3a9dd; background-color: #fff; }
        .purpose-table td { border-bottom: 1px solid #d3d3d3; height: 50px; padding: 10px; vertical-align: top; }
        .purpose-table .last-row td { border-bottom: 1px solid #e4ce0c; }
        .resources-table { width: 100%; border-collapse: collapse; border: 1px solid #dbd8d8; }
        .resources-table th { background-color: #7d1cc2; color: white; padding: 15px; border: 1px solid #dbd8d8; text-align: center; }
        .resources-table td { border: 1px solid #dbd8d8; height: 40px; padding: 5px; text-align: center; background-color: #ffffff; }
        .resources-table tbody tr:nth-child(even):not(.total-row) td { background-color: #f5f5c4; }
        .resources-table tbody tr.total-row td { background-color: #f8f1fc !important; font-weight: bold; text-align: right; }
        .print-btn-container { text-align: right; margin-bottom: 20px; }
        .btn-print { background-color: #4B0082; color: white; padding: 10px 25px; border: none; border-radius: 4px; font-weight: bold; cursor: pointer; font-size: 16px; }

        @media print {
            body { background: white; padding: 0; margin: 0; -webkit-print-color-adjust: exact; print-color-adjust: exact; }
            .form-container { box-shadow: none; padding: 0; max-width: 100%; }
...
<div class="form-container">
    ...
    <table>
        <tr>
            ...
            <td><div class="value-text">{{ $eventRequest->requester_name }}</div></td>
        </tr>
        ...
        <tr>
            ...
            <td><div class="value-text">{{ $eventRequest->contact }}</div></td>
        </tr>
        <tr class="row-highlight">
    ...
    <table>
        <tr>
            ...
            <td><div class="value-text">{{ $eventRequest->event_title }}</div></td>
        </tr>
        <tr class="row-highlight">
        ...
        <tr>
            ...
            <td><div class="value-text">{{ $eventRequest->venue }}</div></td>
        </tr>
        <tr class="row-highlight">
            <td class="label">Expected Participants</td>
            <td><div class="value-text">{{ $eventRequest->participants }}</div></td>
        </tr>
        <tr>
